...
const Banner1 = () => {
    return (
        <>
            <div className='bg-[#252734] px-2 py-20 md:py-20 lg:py-24 xl:py-[10.5rem]'>
                <div className='flex items-center justify-between container '>
                    <div className='flex flex-col items-start justify-center'>
                        ...
                        <h1 className='sm:text-[3.75rem] md:text-[5.31rem] lg:text-[6.87rem] xl:text-[8.75rem]  text-white flex-1 mt-0 md:-mt-6 font-bold'>A H <span className='relative'>Shuvro <img className='absolute right-0 bottom-3' src="assets/img/mark-shape.webp" alt="" /></span></h1>
