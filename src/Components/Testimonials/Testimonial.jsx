            ...
            <div className="container mx-auto">
                ...
                <div className="pt-12 md:pt-14 lg:pt-16 xl:pt-[6.5rem]">
                    <Swiper
                        ...
                        <SwiperSlide>
                            <div className="h-auto w-full bg-[#282A37] flex flex-col items-start justify-center px-3 sm:px-8 md:px-14 lg:px-24 py-12">
                        ...
                        <SwiperSlide>
                            <div className="h-auto w-full bg-[#282A37] flex flex-col items-start justify-center px-6 sm:px-12 md:px-14 py-12">
